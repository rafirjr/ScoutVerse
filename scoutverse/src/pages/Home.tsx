                ...
                <div className="flex-row bg-white rounded-xl mx-auto shadow-lg overflow-hidden w-1/2">
                    ...
                    <div className="flex flex-column w-full p-6 bg-no-repeat bg-cover bg-center bg-slate-500">
                        <div className="w-full flex flex-column items-center justify-center p-8">
                            <button onClick={handleLogInClick} type="button" className="text-lg font-medium py-4 px-8 rounded-lg border border-transparent bg-slate-400 text-white hover:bg-blue-500 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                                Log In
                            </button>
                        </div>
                        <div className="w-full flex flex-column items-center justify-center p-8">
                            <button onClick={handleSignUpClick} type="button" className="text-lg font-medium py-4 px-8 rounded-lg border border-transparent bg-slate-400 text-white hover:bg-blue-500 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                                Sign Up
                            </button>
                        </div>
